...
export var defaultRegexValidator = new RegexValidator();
export function createLenientRegexValidator() {
...
export function createStrictRegexValidator() {
    return new RegexValidator({
        maxLength: 100,
 ...
 */
export function safeCompileRegex(pattern, validator) {
    if (validator === void 0) { validator = defaultRegexValidator; }
