...
exports.createStrictWhitelist = exports.createDefaultWhitelist = exports.SecurityWhitelist = void 0;
...
exports.SecurityWhitelist = SecurityWhitelist;
...
exports.createDefaultWhitelist = createDefaultWhitelist;
function createStrictWhitelist() {
    return new SecurityWhitelist({
        allowedFunctions: new Set([
            'parseInt',
            'parseFloat'
...
exports.createStrictWhitelist = createStrictWhitelist;
