...
exports.getEvaluator = void 0;
var CustomErrors_1 = require("./CustomErrors");
var jsog_1 = __importDefault(require("jsog"));
...
var stringify = function (obj) {
    try {
        ...
        if (e.message.startsWith("Converting circular structure to JSON")) {
            return JSON.stringify(JSON.parse(jsog_1.default.stringify(obj)), null, 2);
        }
        throw e;
    }
};
...
var getEvaluator = function (rootContext, functionsAndVariables, options) {
    var _a, _b, _c, _d;
    ...
    var getHead = function () {
        ...
        throw new CustomErrors_1.UnexpectedError("Stack is empty");
    };
    /**
        ...
        switch (ast.type) {
            ...
            case "MethodReference": {
                ...
                if (ast.methodName === "matches") {
                    ...
                    if (typeof currentContext === "string") {
                        ...
                        try {
                            return (0, RegexValidator_1.safeCompileRegex)(rx, regexValidator)(currentContext);
                        }
                        catch (error) {
                ...
                if (ast.methodName === "MAX") {
                    ...
                    // Validate all arguments are numbers
                    for (var _e = 0, args_2 = args; _e < args_2.length; _e++) {
                        var arg = args_2[_e];
                        if (typeof arg !== "number") {
                            whitelist.exitCall();
            ...
            case "OpMatches": {
                ...
                return binStringOp(function (a, b) {
                    // Use safe regex compilation with validation
                    try {
                        return (0, RegexValidator_1.safeCompileRegex)(b, regexValidator)(a);
                    }
                    catch (error) {
                        throw new Error("Regex validation failed: ".concat(error.message));
                    }
