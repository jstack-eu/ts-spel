...
const evaluator = {
  eval: (value, context, locals) => {
    const ast = parse(value);
    return getEvaluator(context, locals)(ast);
  },
};
...
describe("parse", () => {
  describe("primitives", () => {
    ...
    it("should evaluate a string with embedded escaped single and double quotes", () => {
      //when
      let stringSingle = evaluator.eval("'hello ''world''!'");
      let stringDouble = evaluator.eval('"hello ""world""!"');
      ...
      expect(stringSingle).toBe("hello 'world'!");
      expect(stringDouble).toBe('hello "world"!');
      expect(evaluator.eval("\"hello ''world''!\"")).toBe("hello ''world''!");
      expect(evaluator.eval('\'hello ""world""!\'')).toBe('hello ""world""!');
    });
  ...
  describe("method invocation", () => {
    ...
    /**
     * Lets skip getters and setters for now
